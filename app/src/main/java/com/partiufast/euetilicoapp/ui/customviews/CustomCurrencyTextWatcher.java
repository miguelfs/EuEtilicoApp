...
public class CustomCurrencyTextWatcher implements TextWatcher{
    private CustomCurrencyText editText;
     ...
     */
    public CustomCurrencyTextWatcher(CustomCurrencyText textBox){
     ...
     */
    public CustomCurrencyTextWatcher(CustomCurrencyText textBox, Locale defaultLocale){
        editText = textBox;
        lastGoodInput = "";
